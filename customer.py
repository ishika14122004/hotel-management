...
class Cust_Win:
    def __init__(self,root):
        ...
        img2=Image.open(r"C:\Users\ASUS\OneDrive\Desktop\python project\Images\Hotel_Logo.jpg.jpg")
        ...
        txtmname= ttk.Entry(labelframeleft,width=29,textvariable=self.var_post,font=("arial",13, "bold"))
        ...
        combo_Idproof["value"]=("Aadhar card","Driving Licence","Pan card")
       ...
       #=================below buttons=====================
        ...
        lblSearchBy.grid(row=3,column=0,sticky=W,padx=2)
        ...
        details_table.place(x=0,y=55,width=860,height=350)


        scroll_x = ttk.Scrollbar(details_table, orient=HORIZONTAL)
        scroll_y = ttk.Scrollbar(details_table, orient=VERTICAL)

        self.Cust_Details_Table=ttk.Treeview(details_table, column=("ref","name", "mother", "gender", "post", "mobile", "email", "nationality", "idproof", 
    ...
    def update(self):
        if self.var_mobile.get()=="":
            ...
            conn=mysql.connector.connect(host="localhost", username="root", password="Sevak@3330IITDRMSD",database="management")
            my_cursor=conn.cursor()
            my_cursor.execute("update customer set Name=%s, Mother=%s, Gender=%s, Post Code=%s, Mobile=%s, Email=%s, Nationality=%s, ID Proof=%s, ID Number=%s, Address= %s where Ref=%s",
                                                                                                             (
                                                                                                              self.var_cust_name.get(),
                                                                                                              self.var_mother.get(),
                                                                                                              self.var_gender.get(),
